...
<meta content="GitHub" property="og:site_name" /><meta content="object" property="og:type" /><meta content="https://avatars0.githubusercontent.com/u/342996?v=2&amp;s=400" property="og:image" /><meta content="hglennrock/getting-cleaning-data-project" property="og:title" /><meta content="https://github.com/hglennrock/getting-cleaning-data-project" property="og:url" /><meta content="getting-cleaning-data-project - Repo for the submission of the course project for the Johns Hopkins Getting and Cleaning Data course." property="og:description" />
    ...
    <meta content="collector.githubapp.com" name="octolytics-host" /><meta content="collector-cdn.github.com" name="octolytics-script-host" /><meta content="github" name="octolytics-app-id" /><meta content="3CF20052:2E0B:EDB42D:544D62B4" name="octolytics-dimension-request_id" /><meta content="403570" name="octolytics-actor-id" /><meta content="aakinlalu" name="octolytics-actor-login" /><meta content="457a87685889dff33860631fe341d752e1b2e09e82370c5b068774e678facd4c" name="octolytics-actor-hash" />
...
<meta content="ssejHN0NrISrXbWBi7KpHW0eUHUD2DDXUBQ0+xeyhaMam5Njb04zFdBwNRBzYpPwVyRzq7raCLdbVWntzAuYWA==" name="csrf-token" />
...
<ul class="header-nav user-nav right" id="user-links">
  <li class="header-nav-item dropdown js-menu-container">
    <a class="header-nav-link name" href="/aakinlalu" data-ga-click="Header, go to profile, text:username">
      <img alt="Adebayo Akinlalu" class="avatar" data-user="403570" height="20" src="https://avatars3.githubusercontent.com/u/403570?v=2&amp;s=40" width="20" />
      <span class="css-truncate">
        <span class="css-truncate-target">aakinlalu</span>
      </span>
    </a>
  </li>
...
<ul class="dropdown-menu">
  ...
  <li class="header-nav-item">
    <form accept-charset="UTF-8" action="/logout" class="logout-form" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="dBaKxsK3YoNDuxzGkKngqoeGVCvsPV0WPAmt5i87eg8x0AkZ05VdvCWOOetEBe4mQVrCCapUYR3YP4+2oA0s5w==" /></div>
...
<ul class="pagehead-actions">
    ...
    <li class="subscription">
      <form accept-charset="UTF-8" action="/notifications/subscribe" class="js-social-container" data-autosubmit="true" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="w6ffWBYiYP68ulpfhWNVx5+FLveOFljl9hJFyy8GOOpHgHj+yzFAavqaTA05KY6xj9prY2iBzG16ax4AUC6Mhg==" /></div>  <input id="repository_id" name="repository_id" type="hidden" value="19213479" />
  ...
  <div class="js-toggler-container js-social-container starring-container ">
    ...
    <form accept-charset="UTF-8" action="/hglennrock/getting-cleaning-data-project/unstar" class="js-toggler-form starred js-unstar-button" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="sZc7yGj8wSX4BhG0gh2ckyaxwXgorOPqde+8d1e5uO5ReDiVv5PbHAexAaJjofODcTpnVcwAl5a1ewY0Alt4tw==" /></div>
      <button
    ...
    <form accept-charset="UTF-8" action="/hglennrock/getting-cleaning-data-project/star" class="js-toggler-form unstarred js-star-button" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="JSm7CAIU3M64MDp3rKSYS3sMharhL+XFdCmo995hFBJiY+Pm4bxyOFTP7J7bKFZWI8qyDukEnq8dAzFcuQceRQ==" /></div>
      <button
        class="minibutton with-count js-toggler-target star-button"
        ...
        <li>
          ...
          <a href="/hglennrock/getting-cleaning-data-project/network" class="social-count">15</a>
        </li>
       ...
       --><strong><a href="/hglennrock/getting-cleaning-data-project" class="js-current-repository js-repo-home-link" data-pjax-container-selector="#js-repo-pjax-container">getting-cleaning-data-project</a></strong>
...
<div class="sunken-menu vertical-right repo-nav js-repo-nav js-sidenav-container-pjax js-octicon-loaders" role="navigation" data-issue-count-url="/hglennrock/getting-cleaning-data-project/issues/counts" data-pjax-container-selector="#js-repo-pjax-container">
    ...
    <ul class="sunken-menu-group">
      ...
      <li class="tooltipped tooltipped-w" aria-label="Pull Requests">
        ...
        <li class="tooltipped tooltipped-w" aria-label="Wiki">
          <a href="/hglennrock/getting-cleaning-data-project/wiki" aria-label="Wiki" class="js-selected-navigation-item sunken-menu-item js-disable-pjax" data-hotkey="g w" data-selected-links="repo_wiki /hglennrock/getting-cleaning-data-project/wiki">
...
<div class="clone-url "
  ...
  <div class="input-group">
    ...
    <span class="input-group-button">
      <button aria-label="Copy to clipboard" class="js-zeroclipboard minibutton zeroclipboard-button" data-clipboard-text="git@github.com:hglennrock/getting-cleaning-data-project.git" data-copied-hint="Copied!" type="button"><span class="octicon octicon-clippy"></span></button>
    </span>
  </div>
</div>
      ...
      <div class="actions">
        <div class="button-group">
          ...
          <a class="octicon-button tooltipped tooltipped-nw js-conduit-openfile-check"
             ...
             data-url="github-mac://openRepo/https://github.com/hglennrock/getting-cleaning-data-project?branch=master&amp;filepath=run_analysis.R"
             ...
             data-failed-title="Your version of GitHub for Mac is too old to open this file. Try checking for updates.">
              ...
              <a class="octicon-button tooltipped tooltipped-n js-update-url-with-hash"
                 ...
                 href="/hglennrock/getting-cleaning-data-project/edit/master/run_analysis.R"
                 data-method="post" rel="nofollow"><span class="octicon octicon-pencil"></span></a>

            <a class="octicon-button danger tooltipped tooltipped-s"
               href="/hglennrock/getting-cleaning-data-project/delete/master/run_analysis.R"
...
<div id="jump-to-line" style="display:none">
  ...
  <div class="site-footer" role="contentinfo">
    ...
    <ul class="site-footer-links">
      <li>&copy; 2014 <span title="0.04415s from github-fe118-cp1-prd.iad.github.net">GitHub</span>, Inc.</li>
